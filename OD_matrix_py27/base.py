...
def save_r(N, spd_data, analysis_start_time, time_interval, single_date, link_dict, link_list, link_loc, path_list,
    ...
    pickle.dump(r, open(os.path.join('R_matrix', new_file, date_str + "_pck.pickle"), "wb"))
...
def save_p(N, spd_data, analysis_start_time, time_interval, single_date, path_list, OD_paths, new_file, theta):
    import joblib
    date_str = single_date.strftime("%Y-%m-%d")
    print "date: ", date_str
    P = get_P(N, spd_data, analysis_start_time, time_interval, single_date, path_list, OD_paths, theta)
    # print P
    joblib.dump(P, os.path.join('P_matrix', new_file, date_str + "_0.pickle"))
    pickle.dump(P, open(os.path.join('P_matrix', new_file, date_str + "_0_pck.pickle"), "wb"))
...
def save_p_opt(N, spd_data, analysis_start_time, time_interval, single_date, path_list_opt, OD_paths_opt, new_file, incentive, theta):
    import joblib
    date_str = single_date.strftime("%Y-%m-%d")
    print "date: ", date_str
    ...
    # print P
    joblib.dump(P, os.path.join('P_matrix_opt', new_file, date_str + "_" + str(incentive) + ".pickle"))
    pickle.dump(P, open(os.path.join('P_matrix_opt', new_file, date_str + "_" + str(incentive) + "_pck.pickle"), "wb"))
...
def save_p_opt0(N, spd_data, analysis_start_time, time_interval, single_date, path_list_opt, OD_paths_opt, new_file, theta):
    import joblib
    date_str = single_date.strftime("%Y-%m-%d")
    print "date: ", date_str
    P = get_P_opt0(N, spd_data, analysis_start_time, time_interval, single_date, path_list_opt, OD_paths_opt, theta)
    joblib.dump(P, os.path.join('P_matrix_opt', new_file, date_str + "_0.pickle"))
    pickle.dump(P, open(os.path.join('P_matrix_opt', new_file, date_str + "_0_pck.pickle"), "wb"))
...
def save_tt(N, spd_data, analysis_start_time, time_interval, single_date, path_list_opt, OD_paths_opt, new_file):
    import joblib
    date_str = single_date.strftime("%Y-%m-%d")
    print "date: ", date_str
...
def save_tt_joblib(N, spd_data, analysis_start_time, time_interval, single_date, path_list_opt, OD_paths_opt, new_file):
    import joblib
    date_str = single_date.strftime("%Y-%m-%d")
    print "date: ", date_str
    tt = get_tt(N, spd_data, analysis_start_time, time_interval, single_date, path_list_opt, OD_paths_opt)
    # print tt
    joblib.dump(tt, os.path.join("tt", new_file, date_str + ".pickle"))
    pickle.dump(tt, open(os.path.join("tt", new_file, date_str + "_pck.pickle"), "wb"))
